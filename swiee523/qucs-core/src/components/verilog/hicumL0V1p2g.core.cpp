...
{
double m00_abs(d00_abs0,aa)
double m00_logE(d00_logE1,d00_abs0)
double m00_exp(d00_exp2,(d00_logE1/(1-zedc)))
#if defined(_DERIVATE)
double m10_abs(d10_abs0,d00_abs0,aa)
double m10_logE(d10_logE1,d00_logE1,d00_abs0)
...
aa_Vbi_ci=0.0;
aa_Vb_ci=0.0;
aa_Vtnode_GND=(aa_Vtnode_GND*d10_abs0*d10_logE1/(1-zedc))*d10_exp2;
#endif
aa=d00_exp2;
}
#if defined(_DERIVATE)
