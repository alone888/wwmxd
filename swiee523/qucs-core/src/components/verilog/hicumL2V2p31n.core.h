/*
 * hicumL2V2p31n.core.h - device class definitions for hicumL2V2p31n module
 *
...
#ifndef __hicumL2V2p31n_H__
#define __hicumL2V2p31n_H__

class hicumL2V2p31n : public qucs::circuit
{
 public:
  CREATOR (hicumL2V2p31n);
