...
{
{
double m00_pow(d00_pow0,(BP(n2,n4)-Vto_T2),2.0)
double m00_tanh(d00_tanh1,(Alpha*BP(n3,n4)))
#if defined(_DERIVATE)
double m10_pow(d10_pow0,d00_pow0,(BP(n2,n4)-Vto_T2),2.0)
...
{
double m00_pow(d00_pow0,Vf,2.0)
double m00_tanh(d00_tanh1,(Alpha*BP(n3,n4)))
#if defined(_DERIVATE)
double m10_pow(d10_pow0,d00_pow0,Vf,2.0)
double m10_tanh(d10_tanh1,d00_tanh1,(Alpha*BP(n3,n4)))
#endif
#if defined(_DERIVATE)
...
{
double m00_pow(d00_pow0,(BP(n2,n4)-Vto_T2),2.0)
double m00_pow(d00_pow1,(1-((Alpha*BP(n3,n4))/3)),3.0)
#if defined(_DERIVATE)
double m10_pow(d10_pow0,d00_pow0,(BP(n2,n4)-Vto_T2),2.0)
double m10_pow(d10_pow1,d00_pow1,(1-((Alpha*BP(n3,n4))/3)),3.0)
#endif
#if defined(_DERIVATE)
...
#if defined(_DYNAMIC)
{
double m00_pow(d00_pow0,(BP(n2,n1)-BP(n2,n3)),2.0)
double m00_sqrt(d00_sqrt1,(d00_pow0+(Vdelta1*Vdelta1)))
#if defined(_DERIVATE)
double m10_pow(d10_pow0,d00_pow0,(BP(n2,n1)-BP(n2,n3)),2.0)
...
#if defined(_DYNAMIC)
{
double m00_pow(d00_pow0,(Veff1-Vto),2.0)
double m00_sqrt(d00_sqrt1,(d00_pow0+(Vdelta2*Vdelta2)))
#if defined(_DERIVATE)
double m10_pow(d10_pow0,d00_pow0,(Veff1-Vto),2.0)
...
{
double m00_pow(d00_pow0,(BP(n2,n4)-Vto_T2),2.0)
double m00_pow(d00_pow1,(1+(B*(BP(n2,n4)-Vto_T2))),2.0)
#if defined(_DERIVATE)
double m10_pow(d10_pow0,d00_pow0,(BP(n2,n4)-Vto_T2),2.0)
double m10_pow(d10_pow1,d00_pow1,(1+(B*(BP(n2,n4)-Vto_T2))),2.0)
#endif
#if defined(_DERIVATE)
...
double m00_pow(d00_pow1,((Alpha*BP(n3,n4))/3),3.0)
#if defined(_DERIVATE)
double m10_pow(d10_pow0,d00_pow0,(BP(n2,n4)-Vto_T2),(Qp-1))
double m10_pow(d10_pow1,d00_pow1,((Alpha*BP(n3,n4))/3),3.0)
#endif
#if defined(_DERIVATE)
...
{
double m00_pow(d00_pow0,(1+((Delta*BP(n3,n4))*Ids1)),2.0)
#if defined(_DERIVATE)
double m10_pow(d10_pow0,d00_pow0,(1+((Delta*BP(n3,n4))*Ids1)),2.0)
#endif
#if defined(_DERIVATE)
