/*
 * vcresistor.core.h - device class definitions for vcresistor module
 *
...
#ifndef __vcresistor_H__
#define __vcresistor_H__

class vcresistor : public qucs::circuit
{
 public:
  CREATOR (vcresistor);
