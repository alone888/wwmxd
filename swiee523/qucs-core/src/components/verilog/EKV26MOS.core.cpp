...
{
{
double m00_abs(d00_abs0,(qB+(eta*qI)))
#if defined(_DERIVATE)
double m10_abs(d10_abs0,d00_abs0,(qB+(eta*qI)))
#endif
#if defined(_DERIVATE)
Beta_VSource_int_Bulk=((Beta0prime_VSource_int_Bulk*(1.0+(con21*d00_abs0))-Beta0prime*(con21*(qB_VSource_int_Bulk+(eta*qI_VSource_int_Bulk))*d10_abs0))/(1.0+(con21*d00_abs0))/(1.0+(con21*d00_abs0)));
Beta_VDrain_int_Bulk=((Beta0prime_VDrain_int_Bulk*(1.0+(con21*d00_abs0))-Beta0prime*(con21*(qB_VDrain_int_Bulk+(eta*qI_VDrain_int_Bulk))*d10_abs0))/(1.0+(con21*d00_abs0))/(1.0+(con21*d00_abs0)));
Beta_VGate_Bulk=((Beta0prime_VGate_Bulk*(1.0+(con21*d00_abs0))-Beta0prime*(con21*(qB_VGate_Bulk+(eta*qI_VGate_Bulk))*d10_abs0))/(1.0+(con21*d00_abs0))/(1.0+(con21*d00_abs0)));
#endif
Beta=(Beta0prime/(1.0+(con21*d00_abs0)));
}
}
else
{
...
{
double m00_abs(d00_abs0,qI)
#if defined(_DERIVATE)
double m10_abs(d10_abs0,d00_abs0,qI)
#endif
#if defined(_DERIVATE)
Sthermal_VSource_int_Bulk=(((fourkt*Beta_VSource_int_Bulk)*d00_abs0)+((fourkt*Beta)*qI_VSource_int_Bulk*d10_abs0));
Sthermal_VDrain_int_Bulk=(((fourkt*Beta_VDrain_int_Bulk)*d00_abs0)+((fourkt*Beta)*qI_VDrain_int_Bulk*d10_abs0));
Sthermal_VGate_Bulk=(((fourkt*Beta_VGate_Bulk)*d00_abs0)+((fourkt*Beta)*qI_VGate_Bulk*d10_abs0));
#endif
Sthermal=((fourkt*Beta)*d00_abs0);
}
#if defined(_DERIVATE)
