/*
 * vcresistor.core.cpp - device implementations for vcresistor module
 *
...
#include "vcresistor.analogfunction.h"
#include "component.h"
#include "device.h"
#include "vcresistor.core.h"

#ifndef CIR_vcresistor
#define CIR_vcresistor -1
#endif
...
/* Device constructor. */
vcresistor::vcresistor() : circuit (4)
{
  type = CIR_vcresistor;
}

/* Initialization of model. */
void vcresistor::initModel (void)
{
...
void vcresistor::restartDC (void)
{
}

/* Initialize Verilog-AMS code. */
void vcresistor::initVerilog (void)
{
...
void vcresistor::loadVariables (void)
{
  gain = getPropertyDouble ("gain");
}
...
void vcresistor::initializeModel (void)
{
}

/* Evaluate Verilog-AMS equations in instance initialization. */
void vcresistor::initializeInstance (void)
{
}

/* Evaluate Verilog-AMS equations in initial step. */
void vcresistor::initialStep (void)
{
}

/* Evaluate Verilog-AMS equations in final step. */
void vcresistor::finalStep (void)
{
}

/* Evaluate Verilog-AMS equations in analog block. */
void vcresistor::calcVerilog (void)
{

/* ----------------- evaluate verilog analog equations -------------------- */
double resistance;
#if defined(_DERIVATE)
double resistance_VC1_C2;
#endif
#if defined(_DERIVATE)
resistance_VC1_C2=(gain);
#endif
resistance=(BP(C1,C2)*gain);
if
(resistance>0.0)
{
_load_static_residual2(P1,P2,(BP(P1,P2)/resistance));
#if defined(_DERIVATE)
_load_static_jacobian4(P1,P2,C1,C2,(-BP(P1,P2)*resistance_VC1_C2/resistance/resistance));
_load_static_jacobian4(P1,P2,P1,P2,(1/resistance));
#endif
}
else
{
_load_static_residual2(P1,P2,(BP(P1,P2)*1e6));
#if defined(_DERIVATE)
_load_static_jacobian4(P1,P2,P1,P2,(1e6));
#endif
}
...
void vcresistor::saveOperatingPoints (void)
{
  // save global instance operating points
}

/* Load operating points. */
void vcresistor::loadOperatingPoints (void)
{
}

/* Calculate operating points. */
void vcresistor::calcOperatingPoints (void)
{
}

/* Initialization of AC analysis. */
void vcresistor::initAC (void)
{
  allocMatrixMNA ();
}

/* Perform AC calculations. */
void vcresistor::calcAC (nr_double_t frequency)
{
  setMatrixY (calcMatrixY (frequency));
}

/* Compute Y-matrix for AC analysis. */
matrix vcresistor::calcMatrixY (nr_double_t frequency)
{
  _freq = frequency;
  saveOperatingPoints ();
  matrix y (4);
...
void vcresistor::initSP (void)
{
  allocMatrixS ();
}

/* Perform S-parameter calculations. */
void vcresistor::calcSP (nr_double_t frequency)
{
  setMatrixS (ytos (calcMatrixY (frequency)));
}

/* Initialization of transient analysis. */
void vcresistor::initTR (void)
{
  setStates (2 * 4 * 4);
  initDC ();
}
...
void vcresistor::calcTR (nr_double_t)
{
  doHB = 0;
  doAC = 1;
  doTR = 1;
...
matrix vcresistor::calcMatrixCy (nr_double_t frequency) 
{
  _freq = frequency;
  matrix cy (4);
