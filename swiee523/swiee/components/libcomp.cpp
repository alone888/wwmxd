...
LibComp::LibComp()
{
  ...
  Description = QObject::tr("Component taken from Swiee library");
  ...
  Props.append(new Property("Lib", "", true,
		QObject::tr("name of swiee library file")));
...
{
  QDir Directory(SwieeSettings.LibDir);
  ...
  if(Section.left(14) != "<Swiee Library ")  // wrong file type ?
    return -2;
