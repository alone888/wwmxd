...
class SpiceDialog : public QDialog {
   Q_OBJECT
public:
  SpiceDialog(SwieeApp*, SpiceFile*, Schematic*);
 ~SpiceDialog();
...
private:
  ...
  QProcess *SwieeConv, *SpicePrep;
  QString Line, Error;  // to store the text read from SwieeConv
  int textStatus; // to store with text data SwieeConv will sent next
