...
//#pragma comment (lib, "components/dbg/libcomponents.lib")

//#pragma comment (lib, "diagrams/dbg/libdiagrams.lib")
#include <QtGui>
#include <Q3Dict>
#include <QString>
#include <QStringList>
...
void Module::registerDynamicComponents()
{
  ...
  // vaComponents is populated in SwieeApp::slotLoadModule
