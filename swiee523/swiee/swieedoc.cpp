...
SwieeDoc::SwieeDoc(SwieeApp *App_, const QString& Name_)
{
  App = App_;
...
QString SwieeDoc::fileSuffix (const QString& Name) {
  QFileInfo Info (Name);
  return Info.extension (false);
}

QString SwieeDoc::fileSuffix (void) {
  return fileSuffix (DocName);
}

QString SwieeDoc::fileBase (const QString& Name) {
  QFileInfo Info (Name);
  return Info.baseName (true);
}

QString SwieeDoc::fileBase (void) {
